...
//         prevLastMessages[msg.chat.id] = msg;
//       } else {
//         console.log("Message or chat is undefined:", msg);
//       }
//     });
...
function HomePage() {
  ...
  const handleCreateNewMessage = () => {
    dispatch(
      createMessage({ token, data: { chatId: currentChat.id, content } })
    );
    setContent("");
  };
  ...
  return (
    <div className="relative">
      <div className="w-[100vw] py-14 bg-gradient-to-br from-violet-600 via-blue-500 to-pink-400">
        <div className="flex h-[90vh] absolute top-[5vh] left-[2vw] w-[96vw] rounded-2xl bg-white/10 backdrop-blur-lg shadow-xl border border-white/30">
          <div className="left w-[30%] h-full bg-white/10 backdrop-blur-md border-r border-white/20">
            {isProfile && (
              <Profile handleCloseOpenProfile={handleCloseOpenProfile} />
            )}
            {isGroup && <CreateGroup setIsGroup={setIsGroup} />}
            ...
            <div className="w-full flex flex-col items-center justify-center h-full">
              <div className="w-full px-4 text-center">
                <img
                  ...
                  alt="College-icon"
                />
                <h1 className="text-4xl text-black mt-6">
          ...
          {/* Message screen */}
          {currentChat?.id && (
            <div className="w-[70%] relative bg-white/10 backdrop-blur-md border-l border-white/20">
              <div className="header absolute top-0 w-full bg-white/20 backdrop-blur-md border-b border-white/20">
                <div className="flex justify-between">
                  <div className="py-3 space-x-4 flex items-center px-3">
                    <img
                      className="w-10 h-10 rounded-full"
                  ...
                  <div className="flex py-3 space-x-4 items-center px-3 text-white">
                    <AiOutlineSearch />
                    <BsThreeDotsVertical />
                  </div>
                </div>
              ...
              <div className="footer fixed bottom-0 left-0 w-full bg-white/20 backdrop-blur-md border-t border-white/20 py-3 text-2xl">
                <div className="flex justify-between items-center px-5 relative text-black">
                  <BsEmojiSmile className="cursor-pointer" />
                  <ImAttachment />
                  <input
                    className="py-2 outline-none border-none bg-white/30 backdrop-blur-sm text-black placeholder-black/70 pl-4 rounded-md w-[85%]"
                    type="text"
                    onChange={(e) => setContent(e.target.value)}
                    placeholder="Type message"
                    value={content}
                  ...
                  <button
                    ...
                    className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition duration-200 transform hover:scale-105"
                  >
                    <MdOutlineSend size={24} className="-rotate-45" />
                  </button>
                  <BsMicFill />
                </div>
              </div>
